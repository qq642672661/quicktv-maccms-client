...
require_text "$HANDOFF_DIR/PACK_FIELD_RETURN_ON_MAC.command" 'C920_PREVIEW_TV_SCREEN' "macOS return packer includes C920 evidence note"
require_text "$HANDOFF_DIR/PACK_FIELD_RETURN_ON_MAC.command" 'C920 预览证据数' "macOS return packer logs C920 preview count"
...
require_text "$HANDOFF_DIR/PACK_FIELD_RETURN_ON_WINDOWS.bat" 'C920_PREVIEW_TV_SCREEN' "Windows return packer includes C920 evidence note"
require_text "$HANDOFF_DIR/PACK_FIELD_RETURN_ON_WINDOWS.bat" 'C920 预览证据数' "Windows return packer logs C920 preview count"
...
require_text "$HANDOFF_DIR/FIELD_RETURN_CARD.html" 'C920_PREVIEW_TV_SCREEN' "field return card names C920 preview evidence"
require_text "$HANDOFF_DIR/FIELD_RETURN/README.zh-CN.txt" 'C920_MIC_BUSINESS_INPUT' "field return readme names C920 microphone evidence"
