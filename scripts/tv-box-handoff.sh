...
5. 手机当电视摄像头还在开发/验收时，先打开 TV_BOX_PHONE_CAMERA_CONTRACT.zh-CN.md，看 WebRTC 房间码、手机采集页、信令、隐私和现场验收边界；tv-box-phone-camera-capture-test-latest.md 只证明手机页面具备 getUserMedia/offer/停止按钮，tv-box-phone-camera-signaling-test-latest.md 只证明局域网信令层，不证明真实首帧。
